...
function SignIn() {
  ...
  return (
    <motion.section className="bg-[#d3f9e2] h-screen w-screen">
      <motion.div
        ref={ref}
      ...
      >
        <div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md bg-[#a7f6c7] shadow-xl shadow-black p-4 rounded-lg">
