        ...
        <div className="flex flex-col lg:flex-row h-screen w-screen justify-center items-center max-w-7xl m-auto">
          ...
          >
            ...
            <p className="text-lg text-center">
              We deliver specialized and holistic healthcare services of
              international standards, ensuring compassion for individuals from
              all walks of life
            </p>
          </motion.div>
          <motion.div
            ...
            <div className=" w-[350px] h-[300px] md:h-[350px] flex flex-col  justify-evenly md:justify-between">
              ...
              >
                <div>
                  ...
                  <p className="text-sm">
                    Great doctors demonstrate professionalism through their
                    ethical conduct, reliability, punctuality, and
                    accountability
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <p className="text-sm">
                  Quality in clinical research may be defined as compliance with
                  requirements together with credibility and reliability of the
                  data obtained.
                </p>
              </motion.div>
            </div>
        ...
        <div className="h-full max-w-7xl flex flex-col m-auto justify-center items-center overflow-auto">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex gap-3 ">
              <div className="w-[270px] h-[300px] border border-gray-200 rounded-lg bg-[#73d48e] shadow flex justify-center">
              ...
              <div className="w-[270px] h-[300px] bg-[#73d48e] border border-gray-200 rounded-lg shadow flex justify-center">
                <div className="flex flex-col items-center justify-center ">
                  <img
                    className="w-24 h-24 mb-3 rounded-full shadow-lg"
                    src={doct1}
      ...
      <section>
        <div className=" max-w-7xl m-auto flex flex-col justify-center gap-8 items-center w-full h-full overflow-auto ">
          ...
          >
            ...
            <div className="flex flex-col items-start py-5 p-5 w-[450px] shadow-xl bg-[#7ee5a5] shadow-green-200 rounded-lg">
